...
const chatAnalysisSchema = {
  ...
  schema: {
    ...
    properties: {
      ...
      dimension_summary: { type: "object", additionalProperties: false, required: ["topic_compatibility", "tempo_compatibility", "interaction_balance", "intimacy", "excitement"], properties: { topic_compatibility: { type: "string", maxLength: 180 }, tempo_compatibility: { type: "string", maxLength: 180 }, interaction_balance: { type: "string", maxLength: 180 }, intimacy: { type: "string", maxLength: 180 }, excitement: { type: "string", maxLength: 180 } } },
