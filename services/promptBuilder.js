...
以下の3パターンのうち、状況に合うものを1つだけ選んで出力する。
毎回同じ言い回しにしない。
ただし、必ず「判断」「送るLINE」「注意」の3要素は入れる。
送るLINEは必ず1つだけ。
...
⚠️ 注意
今〇〇しすぎると、相手が〇〇しやすくなります。

パターン3：

この状況は、〇〇を残した方が相手の方から動きやすいです。
