...
const { replyProposalSchema, chatAnalysisSchema, topicAnalysisSchema, themeReportSchema, themeFinalCopySchema } = require("../schemas/outputs");
...
async function callStructured({ prompt, task, imageDataUrl, schema, maxTokens, temperature, validate, reasoningEffort, locale = "ja", modelOverride, maxAttempts = 2 }) {
  let lastError;
